...
- **_Синтаксис не схож с SQL;_**
- **_Доступ только по общему логину паролю;_**
- **_Данные в момент работы хранятся в оперативной памяти, поэтому максимальный ее объем зависит от объема последней._**
